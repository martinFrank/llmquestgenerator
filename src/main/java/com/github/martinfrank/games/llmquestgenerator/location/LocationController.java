...
public class LocationController {
    ...
    public ResponseEntity<String> generateLocations(@RequestBody String questSummaryJson) {
        String result = locationGenerator.generateQuestLocations(questSummaryJson);
